    ...
    public int encodeFirstName(String firstName, String middleInitial) throws MissingNameException{
        ...
        */
        if(firstName == null || firstName == ""){
            ...
            if(firstNameCodeMap.get(firstName.toUpperCase()) != null && middleInitialCodeMap.get(middleInitial.toUpperCase()) != null){
                int code = firstNameCodeMap.get(firstName.toUpperCase()) + middleInitialCodeMap.get(middleInitial.toUpperCase());
                return code;
            }
            else if(firstNameCodeMap.get(firstName.toUpperCase()) == null && middleInitialCodeMap.get(middleInitial.toUpperCase()) != null){
                int code = firstInitialCodeMap.get(firstName.toUpperCase().charAt(0)) + middleInitialCodeMap.get(middleInitial.toUpperCase());
                return code;
            }
            else if(middleInitialCodeMap.get(middleInitial.toUpperCase()) == null){
                if(firstNameCodeMap.get(firstName.toUpperCase()) != null){
                    int code = firstNameCodeMap.get(firstName.toUpperCase());
                    return code;
                }
                else{
                    int code = firstInitialCodeMap.get(firstName.charAt(0));
                    return code;
                }
            }
            else{
